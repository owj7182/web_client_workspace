/**
 * inline 이벤트 속성의 작성 내용이 미리 만들어진 핸들러함수 안에서 실행된다.
 * - 핸들러 하나만 등록가능
 */
const test1 = (e) => {
    console.log('🍡🍭🍬');
...
document.querySelector("#btn4").onclick = function(e) {
    ...
    // this용법 6. 이벤트 핸들러(이벤트) 안의 this는 이벤는 발생 객체를 가리킨다.
    console.log(this);
    console.target(this) === e.target;
};
...
document.querySelector('#memo').onkeyup = (e) => {
    // console.log(e); // a입력시 : key(a) | keycode(65) | code(KeyA)
...
/**
 * 제출버튼 클릭 -> submit이벤트 -> submit이벤트핸들러(유효성 검사) 호출 -> 제출
 * 
