/**
 * 구조분해할당
 * - 배열/객체의 요소를 손 쉽게 변수에 대입하는 방법
 * - 배열은 인데스에 따라, 객체는 속성명에 따라 변수에 대입처리
 */
const test1 = () => {
    const arr = [1, 2, 3];
    // const a = arr[0];
...
const printSns = ({sns : [mainSns, sunSns, ...sns]}) => console.log(mainSns); 
